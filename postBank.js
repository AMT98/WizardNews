...
const data = [
  ...
  },
  {
    ...
    name: 'Baddock',
    date: timeAgo(new Date(Date.now() - 90000000)),
  },
  {
    id: 3,
    upvotes: 198,
    ...
    name: 'Hetty',
    date: timeAgo(new Date(Date.now() - 900000)),
  },
  {
    id: 4,
    upvotes: 171,
    ...
    name: 'Alphard',
    date: timeAgo(new Date(Date.now() - 5000)),
  },
  {
    id: 5,
    upvotes: 166,
    ...
    name: 'Baruffio',
    date: timeAgo(new Date(Date.now() - 10000000)),
  },
  {
    id: 6,
    upvotes: 145,
    ...
    name: 'Hbeery',
    date: timeAgo(new Date(Date.now() - 5000000)),
  },
  {
    id: 7,
    upvotes: 126,
    ...
    name: 'Alatar',
    date: timeAgo(new Date(Date.now() - 600000)),
  },
  {
    id: 8,
    upvotes: 114,
    ...
    name: 'Falco',
    date: timeAgo(new Date(Date.now() - 60000000)),
  },
  {
    id: 9,
    upvotes: 102,
    ...
    name: 'Otto',
    date: timeAgo(new Date(Date.now() - 3000000)),
  },
  {
    id: 10,
    upvotes: 59,
    ...
    name: 'Cuthbert',
    date: timeAgo(new Date(Date.now() - 6000000)),
  },
  {
    id: 11,
    upvotes: 46,
    ...
    name: 'Humphrey22',
    date: timeAgo(new Date(Date.now() - 50000)),
  },
  {
    id: 12,
    upvotes: 30,
  ...
  },
  {
    ...
    name: 'Dracod',
    date: timeAgo(new Date(Date.now() - 60000)),
  },
  {
    id: 14,
    upvotes: 10,
